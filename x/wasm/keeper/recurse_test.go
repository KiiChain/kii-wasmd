...
func TestGasCostOnQuery(t *testing.T) {
	const (
		GasNoWork uint64 = 63_995
		// Note: about 100 SDK gas (10k wasmer gas) for each round of sha256
		GasWork50 uint64 = 64_490 // this is a little shy of 50k gas - to keep an eye on the limit

		GasReturnUnhashed uint64 = 54
		GasReturnHashed   uint64 = 43
	)
